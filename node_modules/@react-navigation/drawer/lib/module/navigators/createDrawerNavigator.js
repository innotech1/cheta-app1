...
import { createNavigatorFactory, createScreenFactory, DrawerRouter, useNavigationBuilder } from '@react-navigation/native';
...
function DrawerNavigator({
  ...
  return render(/*#__PURE__*/_jsx(DrawerView, {
    ...rest,
...
export const createDrawerScreen = createScreenFactory();

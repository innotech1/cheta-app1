...
function DrawerViewBase({
  ...
  React.useEffect(() => {
    ...
    if (previousRouteKey !== focusedRouteKey && descriptors[previousRouteKey]?.options.popToTopOnBlur) {
      ...
      if (prevRoute?.state?.type === 'stack' && prevRoute.state.key && (prevRoute.state.index ?? prevRoute.state.routes.length - 1) > 0) {
        navigation.dispatch({
      ...
      children: state.routes.map((route, index) => {
        ...
        const {
          ...
          header = ({
            ...
            headerLeft: drawerPosition === 'left' && options.headerLeft == null ? props => /*#__PURE__*/_jsx(DrawerToggleButton, {
              ...props
            }) : options.headerLeft,
